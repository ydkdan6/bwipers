...
class FrontendController extends Controller
{
    ...
    public function productDetail($slug)
    {
        ...
        $breadcrumbs = [
            ['label' => 'Product', 'url' => '/shops'],
            ['label' => 'Products Details', 'url' => ''],
        ];
        // dd($product_detail);
        return view('frontend.pages.product_detail', compact('product_detail', 'breadcrumbs'));
    }
    ...
    public function productCat(Request $request)
    {
        ...
        if (request()->is('e-shop.loc/product-grids')) {
            return view('frontend.pages.shop')->with('products', $category->products)->with('recent_products', $recent_products)->with('category', $category);
        } else {
            return view('frontend.pages.shop')->with('products', $category->products)->with('recent_products', $recent_products)->with('category', $category);
        }
    }
    ...
    {
        $category = Category::getProductBySubCat($request->sub_slug);
        // return $category;
        $recent_products = Product::where('status', 'active')->orderBy('id', 'DESC')->limit(3)->get();

        if (request()->is('e-shop.loc/product-grids')) {
            return view('frontend.pages.shop')->with('products', $category->sub_products)->with('recent_products', $recent_products)->with('category', $category);
        } else {
            return view('frontend.pages.shop')->with('products', $category->sub_products)->with('recent_products', $recent_products)->with('category', $category);
        }
    }
