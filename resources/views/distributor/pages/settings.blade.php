                    ...
                    <div class="dashboard_setting_box">
                        <div class="ui_kit_tab style2">
                            ...
                            <ul class="nav nav-tabs mb15" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="socialprofile-tab" data-bs-toggle="tab"
                                        data-bs-target="#socialprofile" type="button" role="tab"
                                        aria-controls="socialprofile" aria-selected="false">Social Profiles</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="bank-tab" data-bs-toggle="tab" data-bs-target="#bank-acc"
                                        type="button" role="tab" aria-controls="bankacc" aria-selected="false">Bank
                                        Details</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content pt20 row" id="myTabContent">
                                <div class="tab-pane fade show active col-lg-12" id="editprofile" role="tabpanel"
                                    ...
                                    <div class="account_details_page form_grid">
                                        ...
                                        <form class="contact_form" name="contact_form"
                                            action=" {{ route('distributor.distributor-settings-update') }} " method="post"
                                            novalidate>
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input class="form-control" type="number" name="phone"
                                                            value="{{ $profile->phone }}" placeholder="Phone Number">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input class="form-control email" type="email" name="email"
                                                            value="{{ $profile->email }}" placeholder="Your Email">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                ...
                                <div class="tab-pane fade col-xl-6" id="bank-acc" role="tabpanel"
                                    aria-labelledby="bank-tab">
                                    <div class="account_details_page form_grid">
                                        <form class="contact_form" name="contact_form"
                                            action=" {{ route('distributor.distributor-settings-update') }} "
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <select name="bank_code" id="bank" class="form-control">
                                                            @foreach ($banks as $bank)
                                                                <option {{ $bank->code == $profile->bank_code ? 'selected' : '' }} value="{{ $bank->code }}">{{ $bank->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input class="form-control" type="tel" name="account_number"
                                ...
                                <div class="tab-pane fade col-xl-6" id="password" role="tabpanel"
                                    ...
                                    <div class="account_details_page form_grid">
                                        ...
                                        @endforeach
                                        <form class="contact_form" name="contact_form"
                                            action="{{ route('distributor.change.password') }}" method="post"
                                            novalidate>
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-12">
                                ...
                                <div class="tab-pane fade col-xl-8" id="closeaccount" role="tabpanel"
                                    ...
                                    <div class="account_details_page form_grid">
                                        <form class="contact_form"
                                            action="{{ route('distributor.distributor-settings-close-account') }}"
                                            method="post" novalidate>
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-10">
                                                    ...
                                                    <p class="fz15 heading-color">Warning: If you close your account, you
                                                        will be unsubscribed from all your personal Transaction, and will
