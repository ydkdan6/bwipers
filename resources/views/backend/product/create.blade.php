        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.store') }}">
              ...
              @endforeach --}}
                ...
                <div class="form-group">
                    <label for="dis_price" class="col-form-label">Distributor's Price(₦) <span
                            class="text-danger">*</span></label>
                    <input id="dis_price" type="number" name="dis_price" placeholder="Enter price"
                        value="{{ old('dis_price') }}" class="form-control">
                    @error('dis_price')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="pack_size" type="number" name="pack_size" min="1" placeholder="E.g. 24 packs"
                        value="{{ $product->pack_size }}" class="form-control">
                    @error('pack_size')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
