...
<div class="page-header" style="height: 180px;">
    ...
    <div class="container">
        <h1 class="page-title mb-0">Become A Distributor</h1>
    </div>
</div>
<!-- End of Page Header -->
...
<div class="page-content become-a-vendor">
    <div class="container create-store pb-1 pb-lg-10 mb-10">
        <div class="row align-items-center">
            <div class="col-md-6 mb-4 mb-md-0">
                <figure class="br-sm">
                    <img src="{{asset('frontend/assets/images/distributor.jpg')}}" alt="Banner"
                        width="610" height="435" style="background-color: #D9D8DD;" />
                </figure>
            </div>
            <div class="col-md-6 order-md-first">
                <h4 class="text-primary font-weight-bold ls-25">Create an account</h4>
                <h2 class="title text-left">Build your online presence on CheriX</h2>
                <p>Become a Distributor for Cherix Baby Wipes, by buying our products in bulk purchase<br>
                    You can easily do better with your online purchase and easy payment for all products purchased<br>
                    Via CheriX Online store.
                </p>
                @auth
                    @else
                    <a href="{{ route('login.form') }}" class="btn btn-dark btn-outline btn-rounded ls-25">Sign Up / Log in</a>
                @endauth
            </div>
        </div>
        <!-- End of Row -->
        ...
        <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <figure class="br-sm">
                        <img src="{{asset('frontend/assets/images/distributor3.jpg')}}" alt="Banner"
                            width="610" height="520" style="background-color: #C9C8CD;" />
                    </figure>
                </div>
                <div class="col-lg-6 pl-lg-8">
                    <h4 class="text-primary font-weight-bold ls-25">How to Become a Distributor</h4>
                    <h2 class="title text-left">Easy 4 steps to manage your products buying</h2>
                    <div class="row cols-sm-2 mb-1">
                        <div class="stage-item mb-6 stage-register d-flex align-items-center">
                            ...
                            <p class="mb-0 font-weight-bold">Register through our phase of Authentication.</p>
                        </div>
                        <div class="stage-item mb-6 stage-selling d-flex align-items-center">
                            ...
                            <p class="mb-0 font-weight-bold">Make a Bulk purchase.</p>
                        </div>
                        <div class="stage-item mb-5 stage-deliver d-flex align-items-center">
                            ...
                            <p class="mb-0 font-weight-bold">Get your product from any location</p>
                        </div>
                        <div class="stage-item mb-5 stage-get d-flex align-items-center">
                            ...
                            <p class="mb-0 font-weight-bold">Payment made secured.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}"
        data-image-src="{{asset('frontend/assets/images/pages/become/2.jpg')}}" style="background-color: #929294;">
        <div class="container">
            <div class="banner-content text-center">
                <h2 class="title title-center text-white font-weight-bold">Let’s talk about how we can
                        Work Together.</h2>
                <a href="{{ route('distributor.onboarding.process') }}" class="btn btn-white btn-outline btn-rounded ls-25">Register Now</a>
            </div>
        </div>
    </div>
</div>
