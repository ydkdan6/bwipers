					...
					<div class="main-content">
							...
							<div class="col-md-6 mb-6 mb-md-8">
								<div class="product-details" data-sticky-options="{'minWidth': 767}">
									...
									<div class="product-bm-wrapper">
										...
										<div class="product-meta">
											<div class="product-categories">
												Category:
												<span class="product-category"><a  href="{{route('product-cat',$product_detail->cat_info['slug'])}}">{{$product_detail->cat_info['title']}}</a></span>
												@if($product_detail->sub_cat_info)
												Sub Category: 
												<span class="product-category"><a href="{{route('product-sub-cat',[$product_detail->cat_info['slug'],$product_detail->sub_cat_info['slug']])}}">{{$product_detail->sub_cat_info['title']}}</a></span>
										@endif
										Stock:
										<span class="product-category"> @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</span>
											</div>
										</div>
									</div>
									...
									<div class="ratings-container">
										...
										<a href="#product-tab-reviews" class="rating-reviews">({{$product_detail['getReview']->count()}} Reviews)</a>
									</div>
						...
						<div class="tab tab-nav-boxed tab-nav-underline product-tabs">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li class="nav-item">
									<a href="#product-tab-reviews" class="nav-link">Customer Reviews ({{count($product_detail['getReview'])}})</a>
								</li>
							</ul>
								...
								<div class="tab-pane" id="product-tab-specification">
									<ul class="list-none">
										<li>
											...
											<p><a href="{{route('product-cat',$product_detail->cat_info['slug'])}}">{{$product_detail->cat_info['title']}}</a></p>
										</li>
										<li>
											<label>Color</label>
											<p>-</p>
							...
							<div class="sticky-sidebar">
								...
								<div class="widget widget-banner mb-9">
									<div class="banner banner-fixed br-sm">
										<figure>
											<img src="{{asset('frontend/assets/images/vendor/element/banner/3.jpg')}}"*/ alt="Banner" width="266"
